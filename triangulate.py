...
def __earth_to_celest( t, p, tgeocent ):
...
def rotate2pole( theta, phi, thetaPole, phiPole, degrees=False ):
    ...
    """
    return hp.Rotator( deg=degrees, rot=[-phiPole, thetaPole, 0], eulertype="ZYZ" )( theta, phi )
